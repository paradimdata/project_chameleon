...
Project Chameleon is free and open source. It can be found on `PyPI <https://pypi.org/project/openmsistream/>`_. It can also be found as a docker image in the Github repository.
